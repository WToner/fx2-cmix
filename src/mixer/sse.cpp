...
// These constants carry an additive offset in the shipped source ((10240+0),
// (7648+1), ...), which is the signature of an automated tuner. They came with
// Shelwien's SSE from mod_ppmd, so they were not necessarily re-fitted for this
// pipeline. Each offset is now overridable; every default is the shipped value,
// so an unmodified build is bit-identical.
#ifndef SSE_D_f0C
#define SSE_D_f0C 0
#endif
#ifndef SSE_D_f1C
...
#endif
#ifndef SSE_D_sm6wrA
#define SSE_D_sm6wrA 0
#endif
#ifndef SSE_D_sm6wrB
#define SSE_D_sm6wrB 0
#endif
#ifndef SSE_D_sm6mw
#define SSE_D_sm6mw 0
#endif
#ifndef SSE_D_sm6C1
#define SSE_D_sm6C1 0
#endif
#ifndef SSE_D_x1W0
#define SSE_D_x1W0 0
#endif
...
#endif
#ifndef SSE_D_sm7wrB
#define SSE_D_sm7wrB 0
#endif
#ifndef SSE_D_sm7mw
#define SSE_D_sm7mw 0
#endif
#ifndef SSE_D_sm7C1
#define SSE_D_sm7C1 0
#endif
#ifndef SSE_D_x2W0
#define SSE_D_x2W0 0
#endif
...
static const int M_f0C = (10240+0+(SSE_D_f0C)) * (1);
static const int M_f1C = (7935+0+(SSE_D_f1C)) * (1);
static const int M_f2C = (9592+0+(SSE_D_f2C)) * (1);
static const int M_sm6wrA = (0+0+(SSE_D_sm6wrA)) * (1);
static const int M_sm6wrB = (106+0+(SSE_D_sm6wrB)) * (1);
static const int M_sm6mw = (0+0+(SSE_D_sm6mw)) * (1);
static const int M_sm6C1 = (8092+0+(SSE_D_sm6C1)) * (1);
static const int M_x1W0 = (7648+1+(SSE_D_x1W0)) * (1);
static const int M_x1wr = (6202+0+(SSE_D_x1wr)) * (1);
static const int M_f3C = (8200+0+(SSE_D_f3C)) * (1);
static const int M_f4C = (7677+0+(SSE_D_f4C)) * (1);
static const int M_sm7wrB = (127+0+(SSE_D_sm7wrB)) * (1);
static const int M_sm7mw = (8192+0+(SSE_D_sm7mw)) * (1);
static const int M_sm7C1 = (8202+0+(SSE_D_sm7C1)) * (1);
static const int M_x2W0 = (2560+1+(SSE_D_x2W0)) * (1);
static const int M_x2wr = (8320+0+(SSE_D_x2wr)) * (1);
